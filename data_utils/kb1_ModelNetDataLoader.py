...
def load_data(dir,classification = False):
    data_train0, label_train0,Seglabel_train0  = load_h5(dir + 'k_but_10.h5')
    data_train1, label_train1,Seglabel_train1 = load_h5(dir + 'k_but_11.h5')
    data_train2, label_train2,Seglabel_train2 = load_h5(dir + 'k_but_12.h5')
    data_train3, label_train3,Seglabel_train3 = load_h5(dir + 'k_but_13.h5')
    data_train4, label_train4,Seglabel_train4 = load_h5(dir + 'k_but_14.h5')
    data_test0, label_test0,Seglabel_test0 = load_h5(dir + 'k_but_1_test0.h5')
    data_test1, label_test1,Seglabel_test1 = load_h5(dir + 'k_but_1_test1.h5')
